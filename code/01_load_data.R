...
rename_merged_r5 <- merged_r5 %>% 
  rename(
    ...
    non_farm_business_revenue_sales_level = s5aq13,
    non_farm_business_revenue_sales_reason_covid_closed = s5aq14_1,
    non_farm_business_revenue_sales_reason_closed_other = s5aq14_2,
    non_farm_business_revenue_compared_prior_school_closure = s5aq15,
    non_farm_business_status = s5aq11a,
    food_insufficient_worry = s8q01,
    food_healthy_lack = s8q02,
    food_few_kinds = s8q03,
